Blockly.Blocks["custom_alert"] = {
  init: function () {
    this.appendValueInput("MESSAGE").setCheck(null).appendField("顯示提示");
...
Blockly.Blocks["custom_log"] = {
  init: function () {
    this.appendValueInput("MESSAGE").setCheck(null).appendField("記錄訊息");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour("#FF6B6B");
...
Blockly.Blocks["custom_wait"] = {
  init: function () {
    this.appendValueInput("TIME").setCheck("Number").appendField("等待");
